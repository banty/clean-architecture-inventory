...
namespace CleanArchitectureInventory.Catalog.API.Filters
{
    public class ApiExceptionFilterAttribute : ExceptionFilterAttribute
    {
        ...
        public void HandleInvalidModelState(ExceptionContext context)
        {
        ...
        public void HandleUnauthorizedAccessException(ExceptionContext context)
        {
            var details = new ProblemDetails
            {
